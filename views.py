...
class NavBar(tk.Menu):
    def __init__(self, parent):
        ...
        menu_file.add_command(label="How to use Password Cracker", command=parent.OpenHelpPage)
...
class MainPage(tk.Frame):
    def __init__(self, parent):
        super().__init__(parent)
        MAIN_FONT = ("Times New Roman", 9, "bold")
        ...
        label_header = tk.Label(parent, text="Password Cracker", font=("Times New Roman", 25))
        label_header.place(rely=0.03, relx=0.02)
        label_author = tk.Label(parent, text="by Aryaman Mishra", font=MAIN_FONT)
        label_author.place(rely=0.1, relx=0.20)
        ...
        btn_extract_dest = ttk.Button(parent, text="Browse folder", command=self._set_extract_path)
        ...
        btn_launch_attack = ttk.Button(parent, text="Crack Password by Dictionary Attack!", command=self._launch_dictionary_attack)
        ...
        self.label_current_target = tk.Label(frame_current_target, text="Select a target Dude.")
...
class HelpPage(BaseWindow):
    def __init__(self):
        ...
        self.title("How to Use Password Cracker")
        bio = (
        ...
        frame_about = tk.LabelFrame(self.base_frame, text="About Password Cracker")
...
class DisclaimerPage(BaseWindow):
    def __init__(self):
        ...
        summary = (
            "Project for Paralle Distributed and Computing by Aryaman Mishra"
        )
        frame_disc = tk.LabelFrame(self.base_frame, text="Password Cracker Disclaimer")
